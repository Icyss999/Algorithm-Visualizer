  ...
  return (
    ...
    >
      <div className="flex flex-col gap-10 items-center justify-center min-h-screen">
        <Label className="text-white font-mono tracking-widest text-4xl">
          {" "}
          Welcome To IcyRhythm
        </Label>
        <Label className="font-mono text-white tracking-widest text-lg">
          {" "}
          The land where you can absorb the knowledge of algorithm
        </Label>
        <Button
